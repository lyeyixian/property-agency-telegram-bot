...
Post the completed plan as a comment on the issue. The plan template already begins with the required prefix line:

> 📋 **Implementation Plan** *(generated by issues-planner)*

Do not remove or alter that line.
...
3. Produce a revised plan using the following template and post it as a new comment:
...
### Changelog
Brief summary of what changed from the previous version and why.

## Technical Implementation Plan

*(same sections as the original template)*
